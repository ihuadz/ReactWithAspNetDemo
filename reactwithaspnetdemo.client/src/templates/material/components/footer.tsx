      ...
      <div className='flex flex-wrap items-start md:justify-between gap-10 md:gap-15'>
        ...
        <div className='max-w-80 md:ml-40'>
          ...
          <div className='flex items-center mt-4'>
            <input
              type='email'
              className='bg-white w-full border border-gray-300 h-9 px-3 outline-none'
            />
        ...
        <div className='flex items-center gap-4'>
          ...
          >
            <Icon
              ...
              className='size-5 text-gray-400 hover:text-indigo-500'
            />
          </a>
          <a
          ...
          >
            <Icon
              icon='lucide:youtube'
              className='size-6 text-gray-400 hover:text-indigo-500'
            />
          </a>
        </div>
      </div>
