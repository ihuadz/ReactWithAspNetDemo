...
import RelatedPost from '@/templates/solid/components/Blog/RelatedPost';
import SharePost from '@/templates/solid/components/Blog/SharePost';
                ...
                <div className='mb-10 w-full overflow-hidden '>
                  <div className='relative aspect-97/60 w-full sm:aspect-97/44'>
                    <Image
                      ...
                      radius='none'
                      className='rounded-md object-cover object-center aspect-2/1'
                      width={'100%'}
                    />
                  </div>
                </div>
